...
PC.display(('Rb','y'),stability=True, figure=1)      # stable and unstable branches as solid and dashed curves, resp.
plt.title('Bifurcation diagram for y variable')
plt.xlim([0.85, 1.2])
PC.display(('Rb','x'),stability=True, figure=2)
plt.xlim([0.85, 1.2])
